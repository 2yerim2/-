...
Python Flask를 사용한 간단한 게시판 애플리케이션입니다.
...
- 프로덕션 환경에서는 `app.secret_key`를 변경해야 합니다.
- 현재는 비밀번호가 평문으로 저장됩니다. 실제 서비스에서는 해시화가 필요합니다.

>>>>>>> 54f3f93 (Add app.py, README, and HTML files generated by Cursor AI)
